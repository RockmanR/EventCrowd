...
/**
* @dev This token contract "MyToken_01" contins a collection of OpenZeppelin Token contracts. And they are:
...
contract MyToken_01 is MintableToken, BurnableToken {
    ...
    /**
   * @dev "burnByCrowdsale" is a function that authorizes Crowdsale contract to burn a specific amount of tokens.
